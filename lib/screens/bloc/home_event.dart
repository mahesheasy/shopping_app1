...
class HomeProductBuyButtonClickedEvent extends HomeEvent {
  final ProductDataModel clickedBuyProduct;

  HomeProductBuyButtonClickedEvent({required this.clickedBuyProduct});
}
